    ...
    <div class="mx-auto flex h-full w-full max-w-6xl items-center justify-center">
      ...
      >
        ...
        >
          ...
          <div class="absolute left-6 top-8 h-24 w-24 rounded-full bg-muted/30 blur-3xl" />
          <div class="absolute right-8 top-14 h-32 w-32 rounded-full bg-muted/25 blur-3xl" />
          <div class="absolute bottom-8 left-10 h-40 w-40 rounded-full bg-border/35 blur-3xl" />
