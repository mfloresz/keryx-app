...
var knownProviders = []ProviderInfo{
	{
		...
		Models: []ModelInfo{
			...
			{ID: "venice/google-gemma-4-26b-a4b-it:disable_thinking=true", UpstreamID: "google-gemma-4-26b-a4b-it:disable_thinking=true", Provider: "venice", DisplayName: "Gemma 4 26B A4B IT", SupportsImages: true, SupportsSearch: true, MaxContext: 0, MaxOutput: 0},
			{ID: "venice/xiaomi-mimo-v2-5", UpstreamID: "xiaomi-mimo-v2-5", Provider: "venice", DisplayName: "Mimo V2.5", SupportsImages: true, SupportsSearch: true, MaxContext: 0, MaxOutput: 0},
			{ID: "venice/mistral-small-2603", UpstreamID: "mistral-small-2603", Provider: "venice", DisplayName: "Mistral Small 4", SupportsImages: true, SupportsSearch: true, MaxContext: 0, MaxOutput: 0},
			{ID: "venice/openai-gpt-oss-120b", UpstreamID: "openai-gpt-oss-120b", Provider: "venice", DisplayName: "GPT OSS 120B", SupportsImages: false, SupportsSearch: true, MaxContext: 0, MaxOutput: 0},
	...
	},
	{
		...
		Models: []ModelInfo{
			...
			{ID: "chutes/mistral-nemo-instruct-2407-TEE", UpstreamID: "unsloth/Mistral-Nemo-Instruct-2407-TEE", Provider: "chutes", DisplayName: "Mistral Nemo", SupportsImages: false, SupportsSearch: true, MaxContext: 0, MaxOutput: 0},
