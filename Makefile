...
.PHONY: frontend build linux-arm64 linux-armv7 compress dev run clean
...
all: build linux-arm64 linux-armv7
...
dev:
	...
	@echo "  1) cd frontend && npm run dev:cloud"
	@echo "  2) go run ./cmd/server --addr :5176 --static-dir ./frontend/dist"
